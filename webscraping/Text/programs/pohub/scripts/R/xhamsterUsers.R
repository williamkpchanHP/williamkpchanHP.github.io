# https://xhamster.com/users/olderwomanfun/videos/1
# https://xhamster.com/users/olderwomanfun/videos/127

dirStr = "D:/Dropbox/MyDocs/R misc Jobs/webscraping/Text/programs/pohub/scripts"
setwd(dirStr)

pageHeader="https://xhamster.com/users/teddy2360/videos/"

pageHead = '<div class="thumb-list__item video-thumb">'
pageEnd = '<div class="pager-section">'
theFilename = "teddy2360.html"
