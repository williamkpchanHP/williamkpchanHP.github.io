...
setwd(dirStr)
catname = "blonde"
pageHead = paste0('https://jizzbunker.com/en/channel/', catname,'/')
seekkey = '<li><figure>'
...
# https://jizzbunker.com/en/trending/513
startNum = 1
endNum = 1142
cat("\nTotal pages: ", (endNum-startNum+1), "\n")
filename = paste0("jizzbunker ",catname,".html")
